...
SELECT f.titre_film, YEAR(f.sortie_film), CONCAT(FLOOR(f.duree_film / 60), ":", f.duree_film % 60), p.prenom_personne, p.nom_personne
FROM film f
...
SELECT f.titre_film, CONCAT(FLOOR(f.duree_film / 60), ":", LPAD(f.duree_film % 60, 2, 0))
FROM film f
